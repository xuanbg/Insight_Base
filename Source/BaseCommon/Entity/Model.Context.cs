...
namespace Insight.WS.Base.Common.Entity
{
    ...
    public partial class BaseEntities : DbContext
    {
        ...
        public virtual IQueryable<Guid> Get_PermAction(Nullable<System.Guid> moduleId, Nullable<System.Guid> userId, Nullable<System.Guid> orgId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Guid>("[BaseEntities].[Get_PermAction](@ModuleId, @UserId, @OrgId)", moduleIdParameter, userIdParameter, orgIdParameter);
        }
    
        [DbFunction("BaseEntities", "Get_PermModule")]
        public virtual IQueryable<Guid> Get_PermModule(Nullable<System.Guid> userId, Nullable<System.Guid> orgId)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Guid>("[BaseEntities].[Get_PermModule](@UserId, @OrgId)", userIdParameter, orgIdParameter);
        }
    
        [DbFunction("BaseEntities", "Get_LoginDept")]
        public virtual IQueryable<Get_LoginDept_Result> Get_LoginDept(string loginName)
        {
            var loginNameParameter = loginName != null ?
                new ObjectParameter("LoginName", loginName) :
                new ObjectParameter("LoginName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Get_LoginDept_Result>("[BaseEntities].[Get_LoginDept](@LoginName)", loginNameParameter);
        }
    
        [DbFunction("BaseEntities", "Get_PermRole")]
        public virtual IQueryable<Guid> Get_PermRole(Nullable<System.Guid> userId, Nullable<System.Guid> orgId)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Guid>("[BaseEntities].[Get_PermRole](@UserId, @OrgId)", userIdParameter, orgIdParameter);
        }
    }
}
